...
<section class="register-content min100vh">
    ...
    <div class="register-cover m-auto">
        <h1 class="form-h1 text-center">İş elanı yerləşdirin(işçi axtaran)</h1>
    </div>
    <div class="personal-information">
        <form action="{{route('isciaxtaran_post')}}" method="post">
            @csrf
            <input type="hidden" value="2" name="add_type">
                ...
                <div class="col-12 col-sm-12 col-md-6 form-col plr-16">
                    <div class="form-element">
                        <div class="form-element">
                            ...
                            <textarea type="text" class="form-control textarea" id="last-name" name="candidate_requirements"></textarea>
                            @if($errors->first('candidate_requirements')) <small class="form-text text-danger">{{$errors->first('candidate_requirements')}}</small> @endif
                        </div>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-6 form-col plr-16">
                    <div class="form-element">
                        <div class="form-element">
                            ...
                            <textarea type="text" class="form-control textarea" id="last-name" name="about_vacancy"></textarea>
                            @if($errors->first('about_vacancy')) <small class="form-text text-danger">{{$errors->first('about_vacancy')}}</small> @endif
                        </div>
                    </div>
                </div>
